  ...
  useEffect(() => {
    ...
    const divergenceShader = compileShader(
      ...
      void main () {
          ...
          if (vL.x < 0.0) { L = -C.x * 0.3; }
          if (vR.x > 1.0) { R = -C.x * 0.3; }
          if (vT.y > 1.0) { T = -C.y * 0.3; }
          if (vB.y < 0.0) { B = -C.y * 0.3; }
    ...
    // Light pastel palette — 浅灰、浅黄、浅红、浅绿
    const PASTEL_COLORS: ColorRGB[] = [
      { r: 0.88, g: 0.88, b: 0.90 },  // 浅灰
      { r: 0.96, g: 0.92, b: 0.78 },  // 浅黄
      { r: 0.94, g: 0.78, b: 0.78 },  // 浅红
      { r: 0.78, g: 0.92, b: 0.82 },  // 浅绿
    ];
