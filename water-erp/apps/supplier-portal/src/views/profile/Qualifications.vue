...
.qual-health { position: relative; display: flex; align-items: center; gap: 20px; padding: 16px 20px; border: 1px solid rgba(255,255,255,0.45); border-left: 4px solid; border-radius: var(--sp-radius-md); background: rgba(255,255,255,0.52); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); margin-bottom: 16px; }
.qual-health::before { content: ''; position: absolute; inset: 0; pointer-events: none; z-index: 0; opacity: 0.40; border-radius: inherit; background-image: radial-gradient(ellipse at 14% 6%, rgba(96,165,250,0.18), transparent 55%), radial-gradient(ellipse at 80% 10%, rgba(56,189,248,0.12), transparent 55%), radial-gradient(ellipse at 36% 90%, rgba(52,211,153,0.08), transparent 55%); animation: glass-glow-drift 18s ease-in-out infinite; }
