      ...
      <Transition name="dlg"><div v-if="crDlg" class="crp-overlay" @click.self="crDlg=false"><div class="crp-panel">
        ...
        <div class="crp-body">
          ...
          <div v-if="crMode==='quals'" v-loading="qualsLoading">
            ...
            <div v-else class="qc-e"><div class="sp-empty-icon"><LucideFolder :size="22" :stroke-width="1.75" /></div><p>暂无资质材料</p></div>
          </div>
          <div v-if="crMode==='contacts'" v-loading="contactsLoading">
            ...
            <div v-else class="qc-e"><div class="sp-empty-icon"><LucidePhone :size="22" :stroke-width="1.75" /></div><p>暂无联系人</p></div>
          </div>
        </div>
...
.qc-e { display: flex; flex-direction: column; align-items: center; text-align: center; padding: 40px 20px; color: var(--muted-foreground); }
