  ...
  return (
    <div className={isFs ? 'fixed inset-0 z-50 bg-white p-4 space-y-2' : 'relative space-y-2'}>
      <button onClick={toggleFs} title={isFs ? '退出全屏' : '全屏'}
        className="fixed bottom-4 right-4 z-[60] w-9 h-9 flex items-center justify-center rounded-lg bg-white/90 border border-[oklch(0.91_0.006_264)] text-[oklch(0.45_0.01_264)] hover:bg-white hover:text-[var(--color-primary)] transition-colors shadow-md">
