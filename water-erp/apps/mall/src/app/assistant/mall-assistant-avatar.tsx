...
export function MallAssistantAvatar({ expression = 'normal', size = 'md', className = '', animated = false }: MallAssistantAvatarProps) {
  ...
  return (
    <span
      className={`relative inline-flex shrink-0 items-center justify-center rounded-full bg-[radial-gradient(circle_at_35%_25%,rgba(232,244,255,.98),rgba(120,184,255,.78)_48%,rgba(54,116,214,.70))] p-1 shadow-[0_10px_26px_rgba(6,78,162,.18)] ring-1 ring-white/70 ${sizeClasses[size]} ${animated ? 'animate-dingdang-breathe avatar-hover-lift' : ''} ${className}`}
    >
