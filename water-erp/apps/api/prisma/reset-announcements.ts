...
function buildBidNoticeContent(row: AnnouncementSeedInput) {
  ...
  return `<h2>${title}</h2>
<p>根据《中华人民共和国招标投标法》《中华人民共和国政府采购法》及四川省水利发展集团有限公司采购管理制度，现就${projectName}组织采购活动，欢迎具备相应资质、业绩和履约能力的供应商参加。本公告内容为供应商报名、编制响应文件和参与评审的重要依据，请潜在投标人认真阅读并按系统要求提交资料。</p>
<h3>一、项目概况</h3>
...
<h3>三、报名及文件获取</h3>
<p>潜在供应商应通过四川省水利发展集团有限公司ERP供应商门户完成注册、资质维护和项目报名。报名资料应真实、完整、清晰，凡因资料缺失、证书过期、联系人信息错误或未按时确认澄清文件造成的后果，由供应商自行承担。采购文件、答疑澄清、补遗通知和开标安排均以平台发布内容为准。</p>
<h3>四、投标要求</h3>
...
function buildWinNoticeContent(row: AnnouncementSeedInput) {
  ...
  return `<h2>${title}</h2>
<p>四川省水利发展集团有限公司${projectName}已按采购文件规定完成开标、评审和结果确认工作。评标委员会依据资格审查、符合性审查、商务技术响应、报价合理性、履约能力和类似业绩等因素进行了独立评审，现将中标候选结果予以公示，接受投标人和社会监督。</p>
<h3>一、项目基本情况</h3>
...
function buildPolicyContent(row: AnnouncementSeedInput) {
  ...
  return `<h2>${title}</h2>
<p>${audience}：为进一步规范四川省水利发展集团有限公司采购管理工作，提升采购活动透明度、合规性和执行效率，根据国家有关法律法规、行业监管要求及集团内部控制制度，现就${focus}等事项作出如下要求。各单位应结合岗位职责认真学习执行，确保采购事项可追溯、可监督、可评价。</p>
<h3>一、总体要求</h3>
...
function buildPlatformContent(row: AnnouncementSeedInput) {
  ...
  return `<h2>${title}</h2>
<p>尊敬的平台用户：为持续提升四川省水利发展集团有限公司ERP招采平台的稳定性、易用性和业务支撑能力，系统将围绕${moduleName}开展功能调整或服务优化。本次公告涉及${features}等内容，请各供应商、评标专家和集团内部用户提前了解相关变化，合理安排业务操作时间。</p>
<h3>一、更新内容</h3>
...
const announcementSeeds = [
    ...
    ...buildAnnouncementSeeds('POLICY', [
      ...
      ['非招标采购方式适用范围及审批流程指引', '询价、谈判采购、单一来源和框架协议采购适用条件', '采购经办人员及项目单位', '2026-06-08'],
