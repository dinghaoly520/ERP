...
const DIRECTIONS = [
  ...
  { specialty: '自动化控制',   title: '高级工程师',         dept: 0, names: ['尤志明', '韦婉清', '聂建国', '巩丽华', '毕晨辉'] },
  ...
  { specialty: '质量检验',     title: '高级工程师',         dept: 3, names: ['洪明辉', '温秀琴', '纪远方', '荣丽梅', '司晓龙'] },
  ...
  { specialty: '税务筹划',     title: '注册税务师',         dept: 2, names: ['霍建华', '傅艳萍', '申伟民', '焦翠兰', '柴国栋'] },
  ...
  { specialty: '消防工程',     title: '高级工程师',         dept: 3, names: ['桑正阳', '武慧敏', '牛国平', '迟丽君', '满建军'] },
  { specialty: '人力资源',     title: '高级人力资源管理师', dept: 6, names: ['尹秋月', '程浩然', '陆佳宁', '傅明哲', '施晓琳'] },
  ...
  { specialty: '景观园林',     title: '高级工程师',         dept: 0, names: ['葛春生', '辛玉兰', '安明辉', '金丽萍', '时广文'] },
  { specialty: '节能环保',     title: '高级工程师',         dept: 3, names: ['单伟强', '管慧芳', '穆振国', '植丽娜', '强建民'] },
  { specialty: '物流采购',     title: '高级物流师',         dept: 1, names: ['汤正伟', '景秋霞', '符立新', '任海燕', '栾国栋'] },
  { specialty: '国际贸易',     title: '高级经济师',         dept: 5, names: ['云兆丰', '冉春梅', '柏峻峰', '麻丽娟', '欧阳文'] },
];
