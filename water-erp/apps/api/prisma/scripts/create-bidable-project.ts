...
function generateBidDocumentBuffer(): Buffer {
  const lines = [
    ...
    '',
    '1. 招标条件',
    `   本招标项目 ${PROJECT_NAME} 已由四川省水利发展集团有限公司批准建设，`,
...
<p>根据《中华人民共和国招标投标法》《中华人民共和国政府采购法》及四川省水利发展集团有限公司采购管理制度，现就<strong>${PROJECT_NAME}</strong>组织公开招标活动，欢迎具备相应资质、业绩和履约能力的供应商参加。本公告内容为供应商报名、编制响应文件和参与评审的重要依据，请潜在投标人认真阅读并按系统要求提交资料。</p>
...
<h3>三、报名及文件获取</h3>
<p>潜在供应商应通过四川省水利发展集团有限公司ERP供应商门户完成注册、资质维护和项目报名。报名资料应真实、完整、清晰，凡因资料缺失、证书过期、联系人信息错误或未按时确认澄清文件造成的后果，由供应商自行承担。采购文件、答疑澄清、补遗通知和开标安排均以平台发布内容为准。招标文件免费提供，不收取任何费用。</p>
