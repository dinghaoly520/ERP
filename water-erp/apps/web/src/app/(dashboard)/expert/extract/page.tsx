...
import { Sparkles, ShieldCheck, AlertTriangle, Check, Plus, X, ChevronDown, ChevronUp, UsersRound, Search, Upload } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <SectionCard
            title={
              mode === 'manual' ? `专业配额 · 手动 · 合计${qt}人`
              : mode === 'upload' ? '推荐上传 · 手动选聘'
              : `专业配额 · AI 推荐 · ${tn}人`
            }
            action={
                      ...
                      <div>
                        ...
                        <div className="rounded-xl border border-[#edf2f7] divide-y divide-[#edf2f7] max-h-[320px] overflow-y-auto">
                          {searchResults.map(exp => {
                            ...
                            return (
                              <div key={exp.id} className={`flex items-center justify-between px-4 py-2.5 ${isSel ? 'bg-[#f0f5ff]' : ''}`}>
