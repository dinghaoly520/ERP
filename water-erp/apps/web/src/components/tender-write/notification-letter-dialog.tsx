                          ...
                          {field.type === "select" ? (
                            ...
                            <div>
                              <input
                                ...
                                className={[
                                  commonInputClass,
                                  isAutoGenerated ? "cursor-default bg-white/60 opacity-80" : "",
                                ].join(" ")}
                              />
                              ...
                              <div className="space-y-1.5">
                                {aiCandidates[field.key].map((candidate, idx) => (
                                  <button
                                    ...
                                    className="w-full p-2 text-left rounded-lg border transition-all duration-200 border-[rgba(171,191,227,0.54)] bg-white hover:bg-[rgba(246,249,255,0.5)]"
                                  >
