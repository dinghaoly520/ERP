...
/**
 * 澄清答疑区块——:3005 开评标指挥中心 Phase 2 新增。
 * 移植自 bid-portal clarifications/page.tsx：澄清/答疑记录表、发起澄清、
 * 内联回复、AI 起草候选问题、AI 摘要、书面来函（含受保护附件下载）。
 * 实时性由父组件的 socket 刷新驱动（detail 变化时重拉列表）。
 */
