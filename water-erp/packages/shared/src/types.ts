...
export interface BidExpert {
  ...
  // P3 host 态（2026-09-20 spec §4.2）：主持人核验登记字段（self 态恒 false/null）
...
export interface Supplier {
  ...
  /** 最近一次评价等级（A/B/C/D/E）；无评价时为 null。由 supplier.service attachAvgScores 附带。 */
