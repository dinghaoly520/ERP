...
| `supplier2` | `supplier2@2026` | supplier (pending) | 供应商门户 (:3004) |
| `caigou` | `caigou@2026` | procurement_staff | 采购管理工作台 (:3005) |
| `wangjg` | `wangjg@2026` | bid_expert | 专家门户 (:3006) |
| `liuxm` | `liuxm@2026` | bid_expert | 专家门户 (:3006) |
| `chenzq` | `chenzq@2026` | bid_expert | 专家门户 (:3006) |
...
> **Generated experts:** 65 additional expert accounts (`exp0101`–`exp1305`, password `<username>@2026`) covering 13 specialties — generated by `apps/api/prisma/scripts/gen-experts.cjs`. Useful for testing expert extraction and large-scale evaluation scenarios.
