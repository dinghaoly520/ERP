...
**Key modules:** `Auth`, `Bid`, `Supplier`, `SupplierPortal`, `Expert` (+ `ExpertAdmin`), `Ai`, `Announcement`, `Notification`, `Upload`, `Procurement`, `Catalog`, `Budget`, `Audit`, `Assistant`, `Scheduler` (cron-only).
